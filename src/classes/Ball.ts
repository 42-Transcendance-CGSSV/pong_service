...
class SendAllowed {
    ...
    class Ball implements BallInterface {
        ...
        constructor() {
            ...
            console.log("canvas height: ", env.CANVAS_HEIGHT, "canvas width: ", env.CANVAS_WIDTH, "ball speed: ", this.ballVelocityX, this.ballVelocityY ,"ball radius : ", this.ballRadius);
        }
