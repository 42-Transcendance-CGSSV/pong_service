...
export function pongController(fastify: FastifyInstance, _options: any, done: () => void) {
    ...
    fastify.register(async function (fastify) {
        ...
        fastify.put(process.env.BASE_ROUTE + "/match/create", { // TODO: can be removed
            schema: {
        ...
        fastify.get(process.env.BASE_ROUTE + "/players", { // TODO: Can be removed
    ...
    fastify.get(process.env.BASE_ROUTE + "/player/:user_id", { 
        ...
        handler: (request: FastifyRequest, reply: FastifyReply) => {
            ...
            console.log(`Fetching player with user_id: ${userId}`);
            const players = MatchManager.getInstance().players;
            if (players.length === 0) {
...
fastify.put(process.env.BASE_ROUTE + "/placeSeated", { // TODO: can be removed
...
fastify.put(process.env.BASE_ROUTE + "/kick", {
